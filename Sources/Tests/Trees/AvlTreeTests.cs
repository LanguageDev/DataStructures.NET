...
public class AvlTreeTests
{
    ...
    {
        var set = new AvlTreeSetLinked(Comparer<int>.Default);
        ValidateTree(set);
    ...
    {
        var set = new AvlTreeSetLinked(Comparer<int>.Default) { Root = InsertCase1Root };
        ValidateTree(set);
    ...
    {
        var set = new AvlTreeSetLinked(Comparer<int>.Default) { Root = InsertCase2Root };
        ValidateTree(set);
        Assert.True(set.Add(15));
        ValidateTree(set);
        AssertTreeEquals(
    ...
    {
        var set = new AvlTreeSetLinked(Comparer<int>.Default) { Root = InsertCase3Root };
        ValidateTree(set);
        Assert.True(set.Add(15));
        ValidateTree(set);
        AssertTreeEquals(
